...
export default function AccessCards({ className = "", Icon, label, value, to }) {
    ...
    return (
        <div className={`bg-surface-hover rounded-2xl cursor-pointer hover:shadow-(--shadow-elevation-3) shadow-(--shadow-elevation-2) p-5 w-70 flex flex-col gap-3 ${className}`} onClick={() => navigate(to)}>
